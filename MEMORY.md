# MEMORY.md — AutoFlow Chrome Extension

> **Last updated**: June 2025
> Comprehensive documentation of the AutoFlow extension architecture, data flow, and implementation details.
...
9. [Content Script — Entry (`content/index.ts`)](#content-script--entry)
10. [Content Script — AutomationEngine (`content/automation.ts`)](#content-script--automationengine)
11. [Content Script — Selectors (`content/selectors.ts`)](#content-script--selectors)
12. [Content Script — Scanner (`content/scanner.ts`)](#content-script--scanner)
13. [Side Panel — UI (`sidepanel/index.ts`)](#side-panel--ui)
14. [Side Panel — Styles (`sidepanel/styles.css`)](#side-panel--styles)
15. [Side Panel — HTML (`sidepanel.html`)](#side-panel--html)
...
- **Frame Chain Section** *(NEW)*: Select multiple images → auto-create overlapping Start/End frame pairs
...
*This document serves as the complete developer reference for the AutoFlow Chrome Extension. Update it when making significant architectural changes.*
