 ...
 * in the Flow adapter requires `cachedUrl.includes('/video/')` before it will
 * save a video. Only the completion test accepted anything.
 *
 * What decides now: what the URL is of, and whose it is.
 */

import { inferState, mediaKindOf, mediaUrlOf, mediaPathId, readStatuses } from '../content/flow/flowBatch';
import { kindSatisfies } from '../content/flow/apiHelper';
